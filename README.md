...
This is FTC Team 18190 TaigaBots' season repository.

Before you change files here, read **[docs/HOW_WE_WORK.md](docs/HOW_WE_WORK.md)**.
That page is the required process for branches, commits, pull requests, and review.

Mentors: **[docs/FOR_MENTORS.md](docs/FOR_MENTORS.md)**
